class EvolvableSound::Synth
  ...
  def self.randomize_args(args: [],
    ...
    { note: lambda { rand(min_note..max_note) },
      ...
      detune: lambda { rand(-detune_range..detune_range) },
      ...
      sub_detune: lambda { rand(-detune_range..detune_range) },
